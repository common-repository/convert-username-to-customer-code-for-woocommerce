(function() {
    ...
    var link = el('a', { href: '#', onclick: toggle }, 'Cambia codice cliente' );
    ...
    var submitButton = el('input', { type: "button", value: "Cambia adesso", className: "button", onclick: onSubmit });
    var form = el('form', {
        method: "POST",
        onsubmit: onSubmit,
        style: { display: "none" }
    ...
    function onSubmit(e) {
        ...
        request.onload = function() {
            submitButton.value = "Cambia adesso";
